...
public class TodasContas extends javax.swing.JFrame {
        ContaCliente conta1;
        Banco banco1;     
        DefaultTableModel Model = new DefaultTableModel(new Object[]{"Todas as Contas", "NºdaConta","TipoDeConta", "NIF", "Socio1 / Tele1", "Socio2 / Tele2", "Socio3 / Tele3"}, 0); //0=qntdd de linhas         
        TipoConta tipo;

    public TodasContas() {
        initComponents();
    }
    public TodasContas(Banco banco, ContaCliente conta) {
        initComponents();
    ...
    private void initComponents() {
        ...
        Tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome do Titular", "NºDaConta", "TipoConta", "NIF", "Socio1 / Tele1", "Socio2 / Tele2", "Socio3 / Tele3"
            }
        ) {
        ...
        jLabel2.setText("Todos as Contas ");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TodasContas().setVisible(true);
            }
        });
    }
